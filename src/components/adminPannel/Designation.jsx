...
const modal='designation'
    ...
    return (
      <div className="flex flex-col justify-center pb-18 items-center h-full mx-auto gap-y-4">
        ...
        <span className="flex flex-col gap-y-2   text-sm xlx:text-[16px] justify-center items-center text-center">
          <p>No records available for this designation</p>
          <p className="text-smallHead xlx:text-sm">It seems there are no tickets or data associated with this designation yet</p>
        </span>
        <button onClick={() => setShowDep(false)} className="bg-customGreen flex justify-center items-center text-white rounded-lg px-3 py-2 text-smallHead w-[151px] h-[40px] hover:bg-liteGreen transition-all">
          <img src={plus} alt="" />
          <span className="pl-1" >Add Designation</span>
  ...
  return (
    ...
    <div className="p-5 mt-3">
      ...
      {/* Grid of Departments */}
      <div className="grid grid-cols-2 pt-2 lg:grid-cols-3 xlss:grid-cols-4 gap-x-6 sm:gap-x-10 xlx:gap-x-[101px] xlss:gap-x-16 gap-y-10 px-2">
        {Array(9)
          .fill(0)
          .map((_, index) => (
            <div
              key={index}
              className="border h-[110px] sm:h-[120px]  border-gray-200 rounded-lg p- bg-white flex flex-col justify-center"
            >
              <div className="flex flex-row pl-2 sm:pl-4 xl:pl-8 gap-x-0 sm:gap-x-2 xl:gap-x-4 xlx:gap-x-3 items-start">
                ...
                <div className="flex flex-col gap-y-1">
                  <h3 className="text-[#00000080] font-customBold3 text-sm sm:text-sub-heading  sm:mb-2 pl-2 sm:pl-0">
                    ...
                    <span className="block text-smallHead xlx:text-[13px] font-customBold3 py-1" >web Development</span>
                  </h3>
              ...
              <div className="flex justify-end space-x-2 pr-2 pt-1 sm:pt-0">
